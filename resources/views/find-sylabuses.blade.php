            ...
            <div class="layout-panel-start">
                ...
                <div class="panel-box">
                    <ol class="action-list-type">
                        ...
                        <a href="{{ route('help'); }}"><li>Pomoc oznaczeń</li></a>     
                        <br>
                    </ol>                    
                </div>
                ...
                <div class="sub-layout-panel-start">
                    ...
                    <div class="panel-list">
                        ...
                        <form action="{{ route('searchSylabuses') }}" method="POST" class="searching-form">
                            @csrf
                            <input type="text" id="searchWord" name="searchName" placeholder="{{ $lastSearchedWord ? $lastSearchedWord : 'Szukaj ...' }}" class="input-search-words" autocomplete="off">
