            ...
            <div class="layout-panel-start">
              ...
              <form class="edit-form" method="post" action="">
                  ...
                  <table>
                      ...
                      <tr>
                          <td><label for="verification_lecturer">Metoda weryfikacji (wykładowca):</label></td>
                          <td><textarea name="verification_lecturer" id="verification_lecturer" rows="4" required></textarea></td>
                      </tr>
                      <tr>
                          <td><label for="verification_exercise">Metoda weryfikacji (ćwiczenia):</label></td>
                          <td><textarea name="verification_exercise" id="verification_exercise"  rows="4" required></textarea></td>
                      </tr>
                      <tr>
                          <td><label for="verification_seminars">Metoda weryfikacji (seminaria):</label></td>
                          <td><textarea name="verification_seminars" id="verification_seminars" rows="4" required></textarea></td>
                      </tr>
                      <tr>
                        <td></td>
