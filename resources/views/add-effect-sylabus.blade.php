...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">            
            ...
            <div class="layout-panel-start">
              ...
              <h2>Dodaj effekt przedmiotu</h2>
              <br>
                <form class="edit-form" method="post" action="{{ route('createEffect', ['id' => $id, 'code' => $code]) }}">
                    @csrf 
                    <table>
                        <tr>
                            <td><label for="symbol">Symbol:</label></td>
                            <td style="width: 80%"><input type="text" name="symbol" id="symbol" class="form-input-fill" required maxlength="100" value=""></td>
                        </tr>
                        <tr>
                            <td><label for="category_effects_id">Kategorie efektu:</label>
                            </td>
                            <td>
                                <select class="custom-input-edit" name="category_effects_id" style="background: white">
                                    <option value="1" selected>Wiedza</option>
                                    <option value="2" >Umiejętności</option>
                                    <option value="3" >Kompetencje społeczne</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="description">Opis:</label></td>
                            <td><textarea name="description" id="description"  rows="4" maxlength="2000" required></textarea></td>
                        </tr>
                        <tr>
                          <td></td>
